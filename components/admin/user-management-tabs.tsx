  ...
  return (
    <Tabs defaultValue="students">
      ...
      <TabsContent value="students">
        <Card>
          <CardHeader><CardTitle>Students</CardTitle><CardDescription>A list of all student accounts.</CardDescription></CardHeader>
          <CardContent>
            <Table>
      ...
      <TabsContent value="faculty">
        <Card>
          <CardHeader><CardTitle>Faculty</CardTitle><CardDescription>A list of all faculty accounts.</CardDescription></CardHeader>
          <CardContent>
            <Table>
